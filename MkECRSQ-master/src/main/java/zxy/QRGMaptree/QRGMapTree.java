...
import zxy.QRGMaptree.geometry.Point;
...
import static zxy.QRGMaptree.geometry.Geometries.rectangle;
 ...
 */
public final class QRGMapTree<T, S extends Geometry> {
     ...
     */
    private QRGMapTree(Optional<? extends Node<T, S>> root, int size, Context context) {
        this.root = root;
        this.size = size;
     ...
     * @param context options for the R-tree
     */
    private QRGMapTree(Node<T, S> root, int size, Context context) {
     ...
     */
    private QRGMapTree(Context context) {
        this(Optional.<Node<T, S>> absent(), 0, context);
    }

    /**
     * Returns a new Builder instance for {@link zxy.QRGMaptree.QRGMapTree}. Defaults to
     ...
     */
    public static <T, S extends Geometry> zxy.QRGMaptree.QRGMapTree<T, S> create() {
    ...
    public static class Builder {
        ...
        /**
         * Builds the {@link zxy.QRGMaptree.QRGMapTree}.
         *
         * @param <T> value type
         * @param <S> geometry type
         * @return RTree
         */
        public <T, S extends Geometry> zxy.QRGMaptree.QRGMapTree<T, S> create() {
            ...
            return new zxy.QRGMaptree.QRGMapTree<T, S>(new Context(minChildren.get(), maxChildren.get(), selector,
                    splitter));
        }
    ...
    public zxy.QRGMaptree.QRGMapTree<T, S> add(Entry<? extends T, ? extends S> entry) {
        if (root.isPresent()) {
            ...
            return new zxy.QRGMaptree.QRGMapTree<T, S>(node, size + 1, context);
        }
        else
            return new zxy.QRGMaptree.QRGMapTree<T, S>(
     ...
     * @return a new immutable R-tree including the new entry
     */
    public zxy.QRGMaptree.QRGMapTree<T, S> add(T value, S geometry) {
     ...
     */
    public zxy.QRGMaptree.QRGMapTree<T, S> add(Iterable<Entry<T, S>> entries) {
        zxy.QRGMaptree.QRGMapTree<T, S> tree = this;
     ...
     */
    public Observable<zxy.QRGMaptree.QRGMapTree<T, S>> add(Observable<Entry<T, S>> entries) {
        return entries.scan(this, new Func2<zxy.QRGMaptree.QRGMapTree<T, S>, Entry<T, S>, zxy.QRGMaptree.QRGMapTree<T, S>>() {

            @Override
            public zxy.QRGMaptree.QRGMapTree<T, S> call(zxy.QRGMaptree.QRGMapTree<T, S> tree, Entry<T, S> entry) {
     ...
     * @return a sequence of trees
     */
    public Observable<zxy.QRGMaptree.QRGMapTree<T, S>> delete(Observable<Entry<T, S>> entries, final boolean all) {
        return entries.scan(this, new Func2<zxy.QRGMaptree.QRGMapTree<T, S>, Entry<T, S>, zxy.QRGMaptree.QRGMapTree<T, S>>() {
     ...
     */
    public zxy.QRGMaptree.QRGMapTree<T, S> delete(Iterable<Entry<T, S>> entries, boolean all) {
        zxy.QRGMaptree.QRGMapTree<T, S> tree = this;
        for (Entry<T, S> entry : entries)
     ...
     * per entry
     */
    public zxy.QRGMaptree.QRGMapTree<T, S> delete(Iterable<Entry<T, S>> entries) {
        zxy.QRGMaptree.QRGMapTree<T, S> tree = this;
        for (Entry<T, S> entry : entries)
     ...
     * object
     */
    public zxy.QRGMaptree.QRGMapTree<T, S> delete(T value, S geometry, boolean all) {
     ...
     */
    public zxy.QRGMaptree.QRGMapTree<T, S> delete(T value, S geometry) {
     ...
     * entry
     */
    public zxy.QRGMaptree.QRGMapTree<T, S> delete(Entry<? extends T, ? extends S> entry, boolean all) {
        if (root.isPresent()) {
            ...
            if (nodeAndEntries.node().isPresent() && nodeAndEntries.node().get() == root.get())
                ...
                return new zxy.QRGMaptree.QRGMapTree<T, S>(nodeAndEntries.node(), size - nodeAndEntries.countDeleted()
     ...
     * entry
     */
    public zxy.QRGMaptree.QRGMapTree<T, S> delete(Entry<? extends T, ? extends S> entry) {
    ...
    /**
     * Returns the always true predicate. See {@link zxy.QRGMaptree.QRGMapTree#entries()} for
     * example use.
     */
    ...
    public Visualizer visualize(int width, int height, Rectangle view) {
        return new Visualizer((zxy.QRGMaptree.QRGMapTree<?, Geometry>) this, width, height, view);
    }
    ...
    private Rectangle calculateMaxView(zxy.QRGMaptree.QRGMapTree<T, S> tree) {
        return tree
                .entries()
