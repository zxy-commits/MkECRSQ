...
public class Combination<T> {
    ...
    public Combination(GraphPoints<T> unit) {
    ...
    public Combination(Combination<T> g) {
        units = new ArrayList<>();
    ...
    public List<Integer> getCandidateUnitCombinationsBackward() {
    ...
    public List<Integer> getCandidateUnitCombinationsForward(int total_point_size) {
    ...
    public Combination mergeUnitCombination(GraphPoints<T> unit) {
        units.add(unit);
